<?php namespace CSI\BbCodeIMDbRating\BbCode\Formatter;

/**
 * Class Base
 * @package CSI\BbCodeIMDbRating\BbCode\Formatter
 */
class Base
{
  /**
   ...
   * @return mixed
   */
  public static function getBbCodeIMDbRating(array $tag, array $rendererStates, \XenForo_BbCode_Formatter_Base $formatter)
  {
    ...
    if ($view) {
      $template = $view->createTemplateObject('csiXF_bbCode_E3DA880E_tag_imdb',
        array(
          'content' => $tagContent,
          'option' => $optDefault,
        ));
